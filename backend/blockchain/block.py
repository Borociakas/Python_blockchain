...
class Block:
    ...
    def mine_block(last_block, data):
        """
        Mines a block based on the given last_block and data, until a block hash is found that meets the neading 0's proof of work requirement.
        """
    ...
    def is_valid_block(last_block, block):
        ...
        Validate block by enforcing the following rules:
            - the block must habe the proper last_hash reference
