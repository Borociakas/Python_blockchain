class TransactionPool:
    ...
    def existing_transaction(self, address):
        """
        Find a transaction generated by address in the transaction pool
        """
    ...
    def transaction_data(self):
        """
        Return the transactions of the transactions pool. Represented in their json serialized form.
        """
        return list(map(
